...
namespace CalamityRangerExtra.Content.WeaponToAMMO.Bullet.DestructionBullet
{
    public class DestructionBulletPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D lightTexture = ModContent.Request<Texture2D>("CalamityRangerExtra/Content/WeaponToAMMO/Bullet/DestructionBullet/DestructionBulletPROJ").Value;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (ModContent.GetInstance<CREsConfigs>().EnableSpecialEffects)
            {
                ...
                Particle blastRing = new CustomPulse(
                    ...
                    "CalamityRangerExtra/texture/ChemicalPollution",
