...
namespace CalamityRangerExtra.Content.WeaponToAMMO.Arrow.TheDrill
{
    public class TheDrillPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityRangerExtra/Content/WeaponToAMMO/Arrow/TheDrill/TheDrill";
