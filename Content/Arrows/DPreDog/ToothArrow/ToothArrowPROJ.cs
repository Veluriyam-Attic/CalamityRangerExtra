...
namespace CalamityRangerExtra.Content.Arrows.DPreDog.ToothArrow
{
    internal class ToothArrowPROJ : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Projectile.DPreDog";
        public override string Texture => "CalamityRangerExtra/Content/Arrows/DPreDog/ToothArrow/ToothArrow";
