...
namespace CalamityRangerExtra.Content.Arrows.DPreDog.PolterplasmArrow
{
    public class PolterplasmArrowPROJ : ModProjectile, ILocalizedModType
    {
        public override string Texture => "CalamityRangerExtra/Content/Arrows/DPreDog/PolterplasmArrow/PolterplasmArrow";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (ModContent.GetInstance<CREsConfigs>().EnableSpecialEffects)
            {
                ...
                Texture2D lightTexture = ModContent.Request<Texture2D>("CalamityRangerExtra/Content/Arrows/DPreDog/PolterplasmArrow/PolterplasmArrow").Value;
