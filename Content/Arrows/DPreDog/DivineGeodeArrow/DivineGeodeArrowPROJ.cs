...
namespace CalamityRangerExtra.Content.Arrows.DPreDog.DivineGeodeArrow
{
    ...
    {
        //public override string Texture => "CalamityRangerExtra/Content/Arrows/DPreDog/DivineGeodeArrow/DivineGeodeArrow";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (ModContent.GetInstance<CREsConfigs>().EnableSpecialEffects)
            {
                ...
                Particle blastRing = new CustomPulse(
                    ...
                    "CalamityRangerExtra/texture/IonizingRadiation",
