...
namespace CalamityRangerExtra.Content.Arrows.DPreDog.EffulgentFeatherArrow
{
    public class EffulgentFeatherArrowPROJ : ModProjectile, ILocalizedModType
    {
        public override string Texture => "CalamityRangerExtra/Content/Arrows/DPreDog/EffulgentFeatherArrow/EffulgentFeatherArrow";
        ...
        {           
            ...
            if (ModContent.GetInstance<CREsConfigs>().EnableSpecialEffects)
            {
                ...
                Texture2D lightTexture = ModContent.Request<Texture2D>("CalamityRangerExtra/Content/Arrows/DPreDog/EffulgentFeatherArrow/EffulgentFeatherArrow").Value;
