...
namespace CalamityRangerExtra.Content.Arrows.CPreMoodLord.PlagueArrow
{
    internal class PlagueArrowPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityRangerExtra/Content/Arrows/CPreMoodLord/PlagueArrow/PlagueArrow";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (ModContent.GetInstance<CREsConfigs>().EnableSpecialEffects)
            {
                ...
                Particle blastRing = new CustomPulse(
                    ...
                    "CalamityRangerExtra/texture/BiologicalHazards",
