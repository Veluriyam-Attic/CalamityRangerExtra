...
namespace CalamityRangerExtra.Content.Arrows.CPreMoodLord.PerennialArrow
{
    public class PerennialArrowPROJ : ModProjectile, ILocalizedModType
    {
        public override string Texture => "CalamityRangerExtra/Content/Arrows/CPreMoodLord/PerennialArrow/PerennialArrow";
