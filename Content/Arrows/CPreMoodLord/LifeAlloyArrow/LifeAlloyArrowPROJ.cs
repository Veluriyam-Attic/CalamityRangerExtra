...
namespace CalamityRangerExtra.Content.Arrows.CPreMoodLord.LifeAlloyArrow
{
    public class LifeAlloyArrowPROJ : ModProjectile, ILocalizedModType
    {
        public override string Texture => "CalamityRangerExtra/Content/Arrows/CPreMoodLord/LifeAlloyArrow/LifeAlloyArrow";
