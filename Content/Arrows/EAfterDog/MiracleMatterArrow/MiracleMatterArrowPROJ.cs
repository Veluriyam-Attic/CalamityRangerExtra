...
namespace CalamityRangerExtra.Content.Arrows.EAfterDog.MiracleMatterArrow
{
    public class MiracleMatterArrowPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (ModContent.GetInstance<CREsConfigs>().EnableSpecialEffects)
            {
                ...
                Texture2D textureGlow = ModContent.Request<Texture2D>("CalamityRangerExtra/Content/Arrows/EAfterDog/MiracleMatterArrow/MiracleMatterArrowPROJ").Value;
