...
namespace CalamityRangerExtra.Content.Arrows.EAfterDog.AuricArrow
{
    ...
    {
        public override string Texture => "CalamityRangerExtra/Content/Arrows/EAfterDog/AuricArrow/AuricArrow";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (ModContent.GetInstance<CREsConfigs>().EnableSpecialEffects)
            {
                ...
                Texture2D lightTexture = ModContent.Request<Texture2D>("CalamityRangerExtra/Content/Arrows/EAfterDog/AuricArrow/AuricArrow").Value;
