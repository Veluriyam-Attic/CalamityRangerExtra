...
namespace CalamityRangerExtra.Content.Arrows.EAfterDog.EndothermicEnergyArrow
{
    public class EndothermicEnergyArrowPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityRangerExtra/Content/Arrows/EAfterDog/EndothermicEnergyArrow/EndothermicEnergyArrow";
