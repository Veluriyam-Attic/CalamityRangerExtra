...
namespace CalamityRangerExtra.Content.Arrows.APreHardMode.AerialiteArrow
{
    public class AerialiteArrowPROJ : ModProjectile, ILocalizedModType
    {
        public override string Texture => "CalamityRangerExtra/Content/Arrows/APreHardMode/AerialiteArrow/AerialiteArrow";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (ModContent.GetInstance<CREsConfigs>().EnableSpecialEffects)
            {
                ...
                Texture2D lightTexture = ModContent.Request<Texture2D>("CalamityRangerExtra/Content/Arrows/APreHardMode/AerialiteArrow/AerialiteArrow").Value;
