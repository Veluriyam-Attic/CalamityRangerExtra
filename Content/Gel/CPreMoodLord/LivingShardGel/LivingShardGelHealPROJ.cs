...
namespace CalamityRangerExtra.Content.Gel.CPreMoodLord.LivingShardGel
{
    internal class LivingShardGelHealPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                // 获取纹理资源和位置
                Texture2D lightTexture = ModContent.Request<Texture2D>("CalamityRangerExtra/Content/Gel/CPreMoodLord/LivingShardGel/LivingShardGelHealPROJ").Value;
