...
namespace CalamityRangerExtra.Content.DeveloperItems.Arrow.ExplodingRabbit
{
    public class ExplodingRabbitPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityRangerExtra/Content/DeveloperItems/Arrow/ExplodingRabbit/ExplodingRabbit";
