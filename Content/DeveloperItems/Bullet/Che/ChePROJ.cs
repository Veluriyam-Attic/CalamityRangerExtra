...
namespace CalamityRangerExtra.Content.DeveloperItems.Bullet.Che
{
    internal class ChePROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityRangerExtra/Content/DeveloperItems/Bullet/Che/Che";
