...
namespace CalamityRangerExtra.Content.DeveloperItems.Bullet.SuperCriticalBullet
{
    public class SuperCriticalBulletPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D lightTexture = ModContent.Request<Texture2D>("CalamityRangerExtra/Content/DeveloperItems/Bullet/SuperCriticalBullet/SuperCriticalBulletPROJ").Value;
