...
namespace CalamityRangerExtra.Content.DeveloperItems.Bullet.Pao
{
    public class PaoPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityRangerExtra/Content/DeveloperItems/Bullet/Pao/Pao";
