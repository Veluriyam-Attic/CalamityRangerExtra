...
//using CalamityMod;
//using CalamityRangerExtra.Content.DeveloperItems.Others.NecromancerQuiver;
//using CalamityMod.Items.Accessories;

//namespace CalamityRangerExtra.Content.DeveloperItems.Others.NecromancerQuiver
//{
