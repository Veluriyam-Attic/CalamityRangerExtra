...
namespace CalamityRangerExtra.Content.DeveloperItems.Weapon.BrassBeast
{
    public class BrassBeastHoldOut : BaseGunHoldoutProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityRangerExtra/Content/DeveloperItems/Weapon/BrassBeast/BrassBeast";
