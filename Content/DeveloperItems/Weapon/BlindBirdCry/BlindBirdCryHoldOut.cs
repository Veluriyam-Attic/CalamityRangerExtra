...
namespace CalamityRangerExtra.Content.DeveloperItems.Weapon.BlindBirdCry
{
    public class BlindBirdCryHoldOut : BaseGunHoldoutProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityRangerExtra/Content/DeveloperItems/Weapon/BlindBirdCry/BlindBirdCry";
