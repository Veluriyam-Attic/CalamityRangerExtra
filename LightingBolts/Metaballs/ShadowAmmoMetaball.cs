...
namespace CalamityRangerExtra.LightingBolts.Metaballs
{
    internal class ShadowAmmoMetaball : Metaball
    {
        ...
        public override void Load()
        {
            ...
            // 加载 Metaball 叠加的纹理层
            LayerAsset = ModContent.Request<Texture2D>($"CalamityRangerExtra/LightingBolts/Metaballs/ShadowAmmoLayer", AssetRequestMode.ImmediateLoad);
        }
