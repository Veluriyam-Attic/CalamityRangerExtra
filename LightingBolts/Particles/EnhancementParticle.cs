...
namespace CalamityRangerExtra.LightingBolts.Particles
{
    public class EnhancementParticle : Particle
    {
        ...
        {
            "CalamityRangerExtra/LightingBolts/Particles/EnhancementParticle1",
            "CalamityRangerExtra/LightingBolts/Particles/EnhancementParticle2",
            "CalamityRangerExtra/LightingBolts/Particles/EnhancementParticle3",
            "CalamityRangerExtra/LightingBolts/Particles/EnhancementParticle4",
            "CalamityRangerExtra/LightingBolts/Particles/EnhancementParticle5"
        };

        // **修正关键点：保证 Mod 加载时 `Texture` 不为空**
        public override string Texture => "CalamityRangerExtra/LightingBolts/Particles/EnhancementParticle1";
