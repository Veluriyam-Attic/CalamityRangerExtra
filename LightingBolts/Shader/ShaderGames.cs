...
namespace CalamityRangerExtra.LightingBolts.Shader
{
    internal class ShaderGames : Mod
    {
        ...
        public override void Load()
        {
            ...
            // **注册拖尾 Shader**
            //GameShaders.Misc["ModNamespace:TailMagic"] = new MiscShaderData(ModContent.Request<Effect>("CalamityRangerExtra/LightingBolts/Shader/TailMagic"), "MagicTrail");
            //GameShaders.Misc["ModNamespace:TailModern"] = new MiscShaderData(ModContent.Request<Effect>("CalamityRangerExtra/LightingBolts/Shader/TailModern"), "ModernTrail");
            //GameShaders.Misc["ModNamespace:TailTechnology"] = new MiscShaderData(ModContent.Request<Effect>("CalamityRangerExtra/LightingBolts/Shader/TailTechnology"), "TechTrail");
        ...
        {
            string path = $"CalamityRangerExtra/LightingBolts/Shader/XNBcoder/Effects/{name}";
            try
            {
